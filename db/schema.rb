...
ActiveRecord::Schema.define(version: 2021_10_02_000149) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["favoriter_id", "listing_id"], name: "index_favorites_on_favoriter_id_and_listing_id", unique: true
  end
